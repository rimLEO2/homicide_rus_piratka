...
SWEP.PrintName = "Крупный Бинт"
SWEP.Instructions	= "Какая-то ткань хлопка, которую можно обернуть вокруг раны, чтобы помочь остановить кровотечение и привести себя в порядок.\n\nЛКМ , чтобы перевязать себя\nПКМ , чтобы перевязать другого игрока"
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
