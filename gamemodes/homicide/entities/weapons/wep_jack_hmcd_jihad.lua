...
SWEP.PrintName = "Пояс Шахида"
SWEP.Instructions	= "Это скрытый пояс, оснащенный взрывчаткой военного класса, окруженный гвоздями и шарикоподшипниками, и детонатор. Используйте его, чтобы закончить свою жалкую жизнь с одним последним Алах Акбар.\n\nЛКМ , чтобы подорвать пояс."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=2
