...
SWEP.PrintName = "Нож"
SWEP.Instructions	= "Это ваш надежный нож из углеродистой стали с фиксированным лезвием. Используй его, чтобы лишить жизни невинных.\n\nЛКМ , чтобы ударить.\nУдар в спину наносит больше урона."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
