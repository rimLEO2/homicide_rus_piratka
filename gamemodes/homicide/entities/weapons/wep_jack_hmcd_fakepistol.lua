...
SWEP.PrintName		= "Муляж Пистолета"
SWEP.Instructions	= "Это пустое, окрашенное в черный цвет оружие для страйкбола. Используйте его, чтобы обмануть невинных и заманить их на погибель, либо притворяясь стрелком, либо нажимая ЛКМ, чтобы бросить в качестве приманки."
SWEP.Slot			= 5
SWEP.SlotPos		= 3
SWEP.DrawAmmo		= false
