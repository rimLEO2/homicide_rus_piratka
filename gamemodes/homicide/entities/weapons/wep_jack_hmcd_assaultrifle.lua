...
SWEP.Instructions	= "Абсурдно мощное оружие,5.56х45-мм полуавтоматическая самозарядная винтовка 30-го калибра является квинтэссенцией вооруженных американских граждан в начале 21 века.\n\nЛКМ, чтобы стрелять.\nПКМ, чтобы прицелиться.\nR для перезарядки.\nПри прриседание стабильность будет больше.\nПули могут рикошетить и пробивать насквозь."
