...
SWEP.PrintName = "Маска Убийцы"
SWEP.Instructions	= "Эта маскировка полностью скроет вашу истинную личность и, вероятно, напугает людей. Используйте его, чтобы избежать раскрытия своей личности во время убийства.\nЛКМ , чтобы надеть маску.\nПКМ , чтобы снять маску."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
