...
SWEP.PrintName = "Большой Расходный Продукт"
SWEP.Instructions	= "Это предмет, который вы можете есть или пить. При употреблении ,медленно востанавливает очки выносливости и здоровья\n\nЛКМ , чтобы съесть или выпить."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
...
function SWEP:PrimaryAttack()
	...
	if(SERVER)then
		if((self.Poisoned)and(self.Owner.Murderer))then
			self.Owner:PrintMessage(HUD_PRINTCENTER,"Это отравлено!")
