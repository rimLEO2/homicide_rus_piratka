...
SWEP.PrintName = "Изолента"
SWEP.Instructions	= "Это рулон скотча с гидрофобным полиэтиленовым покрытием . Используйте его, чтобы склеивать вещи.\n\nЛКМ , чтобы склеить.\nВы можете только положить ленту на шов или закрыть зазор между двумя объектами."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
...
function SWEP:Reload()
	if(SERVER)then self.Owner:PrintMessage(HUD_PRINTCENTER,tostring(self.TapeAmount or 100).."% оставшегося рулона") end
end
