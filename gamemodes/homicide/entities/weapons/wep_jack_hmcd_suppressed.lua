...
SWEP.PrintName		= "Бесшумный Пистолет"
SWEP.Instructions	= "Это полуавтоматический пистолет с десятизарядным магазином и самодельным глушителем. Используйте его, чтобы незаметно убивать невинных.\n\nЛКМ , чтобы выстрелить.\nПКМ , чтобы прицелиться.\nR , чтобы перезарядить.\nСтрельба в присяде более точная.\nПули могут рикошетить и пробивать насквозь."
