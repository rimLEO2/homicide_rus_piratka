...
SWEP.PrintName = "Парализующий Яд"
SWEP.Instructions	= "Это крошечный флакон украденного маслянисто-жидкого нервно-паралитического агента VX, возможно, самого смертоносного из когда-либо синтезированных нервно-паралитических агентов.\n\nЛКМ , чтобы намазать на объект.\nЛюбой, кто схватит или поднимет предмет, будет отравлен."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=2
