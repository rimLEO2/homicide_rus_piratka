...
SWEP.PrintName = "Инъекция Адреналина"
SWEP.Instructions	= "Это инжектор адреналина для остановки аллергических реакций. Используйте его, чтобы дать себе серьезный заряд выносливости для поимкм жертвы."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=2
