...
SWEP.PrintName = "Канистра Цианида"
SWEP.Instructions	= "Это какой-то адсорбированный на черном рынке водородно-цианистый газ, повторно запечатанный в оригинальной нацистской канистре "Циклон-Б" времен Второй мировой войны. После открытия газ заполняет небольшую область в течение нескольких минут и отравляет все внутри.\n\nЛКМ , чтобы открыть и бросить.\nПокиньте данную область после вскрытия."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=2
