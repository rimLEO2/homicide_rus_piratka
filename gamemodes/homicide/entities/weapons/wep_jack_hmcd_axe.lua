...
SWEP.PrintName = "Топор Дровосека"
SWEP.Instructions	= "Это типичный топор дровосека с острой стальной головкой. Создан для истинных психопатов\n\nЛКМ , чтобы взмахнуть.\nМожет также ломать двери и разрушать укрепления."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
