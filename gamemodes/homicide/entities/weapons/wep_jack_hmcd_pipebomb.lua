...
SWEP.PrintName = "Самодельная Бомба"
SWEP.Instructions	= "Это самодельное взрывное устройство представляет собой тяжелую стальную трубу, заполненную черным порошком и окруженную гвоздями. Он имеет простой короткий пиротехнический взрыватель. Этот прибор достигает высокой скорости детонации и проекции шрапнели через плотное сдерживание черного порошка. Однако он все еще не так смертоносен и надежен, как настоящая граната.\n\nЛКМ , чтобы зажечь и бросить."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
