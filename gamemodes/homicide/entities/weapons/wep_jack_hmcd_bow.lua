...
SWEP.PrintName = "Охотничий Лук"
SWEP.Instructions	= "Это современный алюминиево-стекловолоконный составной лук с силой натяжения 290 ньютонов, используемые на средней дистанции в Северо-Американской игре.\n\nПКМ , чтобы прицелиться.\nЛКМ , чтобы выстрелить."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=2
