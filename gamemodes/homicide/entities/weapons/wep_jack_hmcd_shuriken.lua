...
SWEP.Instructions	= "Это тяжелая стальная звезда с шестью острыми наконечниками. Бросьте его, чтобы навредить людям издалека. Не так сильно повреждает, как удар ножом, но это что-то.\n\nЛКМ , чтобы метнуть.\nВы автоматически восстановите сюрикен через некоторое время."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
