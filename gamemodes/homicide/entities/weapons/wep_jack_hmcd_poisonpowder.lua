...
SWEP.Instructions	= "Это порошок цианистого калия в капсуле. Смешайте его с едой или питьем для скрытого убийства.\n\nЛКМ , чтобы смешать с едой.\nКто-то должен съесть его.\nТребует времени для воздействия на организм жертвы.\nОдноразовый"
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=2
