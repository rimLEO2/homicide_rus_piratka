...
SWEP.Instructions	= "Это стандартная потребительская рация среднего радиуса действия. Используйте её, чтобы общаться (или шпионить).\n\nС этим в руке всё, что вы говорите в чате, передается всем людям, у которых также есть рация, независимо от расстояния или прямой видимости."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
