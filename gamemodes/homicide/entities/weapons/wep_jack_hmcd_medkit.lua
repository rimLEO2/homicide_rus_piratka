...
SWEP.Instructions	= "Это гражданская аптечка первой помощи, содержащая гемостатические средства, бинты, антибиотики, дезинфицирующие средства, обезболивающие и некоторые основные пайки.\n\nЛКМ , подлатать себя.\nПКМ , подлатать другого игрока."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
