...
SWEP.PrintName = "Взрыв Пакет"
SWEP.Instructions	= "Это крошечная коробка с взрывоопасным вещестовм. Используйте его, чтобы создать смертельную ловушку.\n\nНажмите ЛКМ, чтобы незаметно скрыть заряд взрывчатого вещества в/на объекте.\nПКМ,чтобы установить хрупкую, очевидную бомбу.\nПосле установки нажмите ЛКМ, чтобы взорвать.\nВзрывная волна может сносить двери , в зависимости от расположения бомбы."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=2
