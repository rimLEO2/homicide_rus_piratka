...
SWEP.PrintName = "Болеутоляющее Средство"
SWEP.Instructions	= "Несколько нестероидных противовоспалительных препаратов (ибупрофен, ацетаминофен, аспирин) в одном пластиковом флаконе. Они позволяют человеку ,если ранен , бегать и прыгать.\n\nЛКМ , принять таблетки."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
