...
SWEP.PrintName = "Дверной Клин"
SWEP.Instructions	= "Это сверхмощный коммерческий дверной клин. Его можно установить в любую дверь, чтобы её не открыли снаружи\n\nЛКМ , чтобы заблокировать дверь.\nНажми E , чтобы подобрать/убрать клин."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=3
