...
SWEP.PrintName = "Дымовая Шашка"
SWEP.Instructions	= "Это домашняя дымовая шашка из KNO3 и сахара, полезная для скрытого убийства людей.\n\nЛКМ , чтобы зажечь фитиль и бросить.\nДым заполнит комнату и через некоторое время развеется."
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=2
