...
concommand.Add("hmcd_taunt", function (ply, com, args, full)
	...
	if !taunts[cat] then return end -- if he's not TAUNTING THE CAT then return end

	local sex = string.lower(ply.ModelSex or "male")
	if !taunts[cat][sex] then return end

	local taunt = table.Random(taunts[cat][sex]) -- random table cat taunt sex, sounds kinky
