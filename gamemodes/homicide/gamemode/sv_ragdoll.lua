...
local dtypes = {}
dtypes[DMG_GENERIC]=""
dtypes[DMG_CRUSH]="Ты разбился насмерть"
dtypes[DMG_BULLET]="Ты был подстрелян"
dtypes[DMG_SLASH]="Ты был жестоко зарезан"
dtypes[DMG_BURN]="Ты поджарился до корочки"
dtypes[DMG_VEHICLE]="Ты погиб в аварии"
dtypes[DMG_FALL]="Ты не сдружился с силой притяжения"
dtypes[DMG_BLAST]="Ты был разорван взырвной волной на мелкие кусочки"
dtypes[DMG_CLUB]="Тебя жестоко избили"
dtypes[DMG_SHOCK]="Ты был шокирован"
dtypes[DMG_SONIC]="Ты оказался слишком быстрым для этого мира"
dtypes[DMG_ENERGYBEAM]="Ты решил испытать на себе энерго-луч"
dtypes[DMG_DROWN]="Ты разделил учесть Титаника"
dtypes[DMG_PARALYZE]="Ты был парализован" -- you mean PARALYSIS? Fucking moron.
dtypes[DMG_NERVEGAS]="Ты вдохнул слишком много ядовитого газа"
dtypes[DMG_POISON]="Ты погиб от отравления"
dtypes[DMG_RADIATION]="Ты не смог пережить радиоактивное излучение"
dtypes[DMG_DROWNRECOVER]=""
dtypes[DMG_ACID]="Ты был растворён в сильной кислоте"
dtypes[DMG_PLASMA]="Ты испытал на себе плазмо-пушку"
dtypes[DMG_AIRBOAT]="Ты был сбит лодкой"
dtypes[DMG_DISSOLVE]="Ты был стёрт с лица Земли"
dtypes[DMG_BLAST_SURFACE]=""
dtypes[DMG_DIRECT]="Тебя подожгли"
dtypes[DMG_BUCKSHOT]="Ты был подстрелян из дробовика"
