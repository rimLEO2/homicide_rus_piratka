...
function GM:DisplayEndRoundBoard(data)
	...
	menu:SetTitle("Статистика за Раунд")
	menu:MakePopup()
	...
	if(data.reason==4)then
		if(self.ZOMBIE)then
			winner:SetText("Выжившие побеждают! Альфа-зомби сдался")
		elseif(self.SHTF)then
			winner:SetText("Невинные побеждают! Предатель сдался.")
		else
			winner:SetText("Невинные побеждают! Убийца сдался.")
		end
		winner:SetTextColor(Color(255, 255, 255))
	elseif data.reason == 3 then
		if(self.ZOMBIE)then
			winner:SetText("Выжившие побеждают! Альфа-зомби покинул игру")
		elseif(self.SHTF)then
			winner:SetText("Невинные побеждают! Предатель покинул игру")
		else
	...
	elseif data.reason == 2 then
		if(self.ZOMBIE)then
			winner:SetText("Выжившие побеждают!")
		elseif(self.SHTF)then
			winner:SetText("Невинные побеждают!")
		else
	...
	if(Showin)then
		...
		Bottom:SetTitle("                         Лучший: "..Dude:GetBystanderName())
		Bottom:MakePopup()
